            ...
            <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
                <div class="col-lg-8 ftco-animate">
                    <div class="text w-100 text-center mb-md-5 pb-md-5">
                        ...
                        <p style="font-size: 18px;">Sebuah sungai kecil bernama Duden mengalir di dekat tempat mereka dan memasok
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="services-wrap rounded-right w-100">
                                ...
                                <p><a href="#" class="btn btn-primary py-3 px-4">Pesan Mobil Sempurna Anda</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 wrap-about ftco-animate">
                    <div class="heading-section heading-section-white pl-md-5">
                        ...
                        <p>Selamat datang di RENT MOBIL Kami! penyedia solusi transportasi terdepan yang siap memenuhi segala kebutuhan perjalanan Anda dengan armada mobil terbaru, layanan prima, dan harga yang kompetitif. Kami berkomitmen untuk memberikan pengalaman berkendara yang nyaman, aman, dan menyenangkan bagi setiap pelanggan kami, baik untuk perjalanan bisnis, liburan keluarga, maupun acara khusus. Dengan proses pemesanan yang mudah dan dukungan pelanggan 24/7, kami berharap dapat menjadi mitra terpercaya Anda dalam setiap perjalanan. Terima kasih telah memilih kami, dan semoga Anda menikmati perjalanan Anda bersama kami!</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3">
                    <div class="services services-2 w-100 text-center">
                        ...
                        <div class="text w-100">
                            ...
                            <p>Nikmati layanan rental mobil premium kami untuk acara pernikahan Anda, lengkap dengan dekorasi elegan dan sopir profesional, memastikan hari istimewa Anda berjalan sempurna.</p>
    </div>
                        </div>
                </div>
                <div class="col-md-3">
                    <div class="services services-2 w-100 text-center">
                        ...
                        <div class="text w-100">
                            ...
                            <p>Nikmati kemudahan layanan antar-jemput antar kota dengan armada kami, menjadikan perjalanan Anda lebih efisien dan nyaman.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services services-2 w-100 text-center">
                        ...
                        <div class="text w-100">
                            ...
                            <p>Nikmati kemudahan layanan antar jemput bandara dari Rental Mobil Kami. 
                                Kami siap menjemput Anda tepat waktu dan mengantar Anda ke tujuan dengan nyaman dan aman. Pilihlah kami untuk pengalaman perjalanan yang bebas stres dan menyenangkan!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="services services-2 w-100 text-center">
                        ...
                        <div class="text w-100">
                            ...
                            <p>Nikmati fitur unggulan kami, yaitu layanan antar tur seluruh kota! Dengan kendaraan yang nyaman dan sopir berpengalaman, Anda bisa menjelajahi setiap sudut kota dengan tenang dan aman. Sempurnakan perjalanan Anda bersama Rental Mobil Kami! </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        <div class="item">
                            <div class="testimony-wrap rounded text-center py-4 pb-5">
                                ...
                                <div class="text pt-4">
                                    <p class="mb-4">Saya suka dengan layanan rental mobil karna mobil bersih dan datang tepat waktu.  </p>
                                    <p class="name">Fika</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap rounded text-center py-4 pb-5">
                                ...
                                <div class="text pt-4">
                                    <p class="mb-4">Kami menyewa mobil kecil selama 3 hari. Semuanya berjalan dengan sangat baik. Mobil diantarkan ke hotel. Serah terima sangat tepat waktu, semuanya dijelaskan dengan baik. 
                                        Nomor telepon dipertukarkan sehingga kami dapat segera dihubungi jika ada masalah. Jadi kami sangat puas. </p>
                            ...
                            <div class="testimony-wrap rounded text-center py-4 pb-5">
                                ...
                                <div class="text pt-4">
                                    <p class="mb-4">Rental mobil yang profesional dan sangat membantu. 
                                        Layanan antar dan jemput mobil di bandara yang fantastis.Mobil yang terawat dengan baik. Sangat direkomendasikan!</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap rounded text-center py-4 pb-5">
                                ...
                                <div class="text pt-4">
                                    <p class="mb-4">Kami menerima mobil sewaan yang kami inginkan di hotel di Mauritius tepat waktu, bahkan 45 menit lebih awal dari yang dijadwalkan.</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap rounded text-center py-4 pb-5">
                                ...
                                <div class="text pt-4">
                                    <p class="mb-4">Staf yang ramah, mediasi yang baik, harga yang wajar. Ketika saya lupa membawa kacamata mahal saya di laci
                                         dasbor saat menjelajahi pulau pertama di Seychelles, mereka mengatur agar saya mengambilnya di bandara sebelum keberangkatan!</p>
